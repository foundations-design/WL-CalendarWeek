    ...
    "with test12.ics (testing recurrences and exdates)": {
      ...
      "event with rrule": {
        ...
        "Has two EXDATES": function (topic) {
          ...
          assert.notEqual(
            topic.exdate[
              new Date(2015, 06, 08, 12, 0, 0).toISOString().substring(0, 10)
            ],
            undefined
          );
          assert.notEqual(
            topic.exdate[
              new Date(2015, 06, 10, 12, 0, 0).toISOString().substring(0, 10)
            ],
            undefined
          );
        },
        "Has a RECURRENCE-ID override": function (topic) {
          ...
          assert.notEqual(
            topic.recurrences[
              new Date(2015, 06, 07, 12, 0, 0).toISOString().substring(0, 10)
            ],
            undefined
          );
          assert.equal(
    ...
    "with test13.ics (testing recurrence-id before rrule)": {
      ...
      "event with rrule": {
        ...
        "Has a RECURRENCE-ID override": function (topic) {
          ...
          assert.notEqual(
            topic.recurrences[
              new Date(2016, 7, 26, 14, 0, 0).toISOString().substring(0, 10)
            ],
            undefined
          );
          assert.equal(
    ...
    "with test14.ics (testing comma-separated exdates)": {
      ...
      "event with comma-separated exdate": {
        ...
        "Has four comma-separated EXDATES": function (topic) {
          ...
          assert.notEqual(
            topic.exdate[
              new Date(2017, 6, 6, 12, 0, 0).toISOString().substring(0, 10)
            ],
            undefined
          );
          assert.notEqual(
            topic.exdate[
              new Date(2017, 6, 17, 12, 0, 0).toISOString().substring(0, 10)
            ],
            undefined
          );
          assert.notEqual(
            topic.exdate[
              new Date(2017, 6, 20, 12, 0, 0).toISOString().substring(0, 10)
            ],
            undefined
          );
          assert.notEqual(
            topic.exdate[
              new Date(2017, 7, 3, 12, 0, 0).toISOString().substring(0, 10)
            ],
            undefined
          );
          ...
          assert.equal(
            topic.exdate[
              new Date(2017, 4, 5, 12, 0, 0).toISOString().substring(0, 10)
            ],
            undefined
          );
        }
    ...
    "with test14.ics (testing exdates with bad times)": {
      ...
      "event with exdates with bad times": {
        ...
        "Has two EXDATES even though they have bad times": function (topic) {
          ...
          assert.notEqual(
            topic.exdate[
              new Date(2017, 11, 18, 12, 0, 0).toISOString().substring(0, 10)
            ],
            undefined
          );
          assert.notEqual(
            topic.exdate[
              new Date(2017, 11, 19, 12, 0, 0).toISOString().substring(0, 10)
            ],
            undefined
          );
        }
